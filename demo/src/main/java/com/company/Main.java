                        ...
                        case 1:
                        {
                            while (true)
                            {
                                ...
                                if(log==1)
                                {
                                    ...
                                    boolean data = database.addUserList(new Driver(userName,mobile,password,nationalId,new DrivingLiscence(liscenseId,liscensetype),rideRequests));
                                    if(data)
                                    {
                                ...
                                if(log==1)
                                {
                                    ...
                                    while (true) {
                                        ...
                                        if (log == 1) {
                                            ...
                                            passenger.requestRide(new Ride(source, destination));
